...
CREATE INDEX IF NOT EXISTS idx_processed_ran_metrics_site_ingested
    ON processed_ran_metrics (site_id, ingested_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_weather_metrics_site_ingested
    ON weather_metrics (ran_site_id, ingested_at DESC);
